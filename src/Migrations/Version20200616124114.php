 ...
 */
final class Version20200616124114 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, collection_point_type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, devenir LONGTEXT DEFAULT NULL, INDEX IDX_64C19C1A9B99F90 (collection_point_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE material (id INT AUTO_INCREMENT NOT NULL, collection_point_type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, devenir LONGTEXT DEFAULT NULL, INDEX IDX_7CBE7595A9B99F90 (collection_point_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
