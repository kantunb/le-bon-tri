 ...
 */
final class Version20200617174609 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, collection_point_type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, devenir LONGTEXT DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, INDEX IDX_64C19C1A9B99F90 (collection_point_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE material (id INT AUTO_INCREMENT NOT NULL, collection_point_type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, devenir LONGTEXT DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, INDEX IDX_7CBE7595A9B99F90 (collection_point_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE objet (id INT AUTO_INCREMENT NOT NULL, material_id_id INT NOT NULL, use_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, avoid_production LONGTEXT DEFAULT NULL, valide TINYINT(1) NOT NULL, new_name VARCHAR(255) DEFAULT NULL, INDEX IDX_46CD4C3829A33219 (material_id_id), INDEX IDX_46CD4C38E3D2B46D (use_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
